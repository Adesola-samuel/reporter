...
class Reservation(models.Model):
    ...
    officer = models.CharField(max_length=25, null=True, blank=True)
    fleet = models.CharField(max_length=14, null=True, blank=True)
    reported_by = models.CharField(max_length=25, null=True, blank=True)

    def __str__(self):
        return f"{self.cab_no} {self.officer} {self.fleet} {self.notification_date} {self.type}"

class TrucksInsideWorkshop(models.Model):
    cab_no = UpperCharField(max_length=14)
    officer = models.CharField(max_length=25, null=True, blank=True)
    fleet = models.CharField(max_length=14, null=True, blank=True)
    ...
    def __str__(self):
        return f"{self.cab_no} {self.officer} {self.admmited}"
